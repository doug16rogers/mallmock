...
/**
 * Examines the result of running @a _code and returns its value if it is not
 * `CUT_RESULT_PASS`.
 */
...
#define CUT_FL_ASSERT_NOT_NULL(_f,_l,_a)            CUT_FL_ASSERT(_f,_l, ((_a) != NULL))
...
#define CUT_ASSERT_NOT_NULL(_a)            CUT_FL_ASSERT_NONNULL(__FILE__,__LINE__, (_a))
